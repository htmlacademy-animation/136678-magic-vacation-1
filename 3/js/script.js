...
class FullPageScroll {
  constructor() {
    ...
    this.bgScreen = document.querySelector(`.bg-screen`);
  ...
  changeVisibilityDisplay() {
    if (this.activeScreen === 2) {
      this.bgScreen.classList.add(`active`);
    }
    ...
    setTimeout(() => {
      ...
      this.bgScreen.classList.remove(`active`);
...
/* harmony import */ var _modules_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/page */ "./source/js/modules/page.js");
// modules
...
Object(_modules_page__WEBPACK_IMPORTED_MODULE_9__["default"])();
